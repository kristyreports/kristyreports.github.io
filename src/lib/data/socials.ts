...
const socialMedias: Social[] = [
  ...
  { href: 'https://muckrack.com/kristy-moore', icon: 'fa-solid fa-newspaper', label: 'Muck Rack' },
  { href: 'https://linkedin.com/in/kristyqmoore', icon: 'fa-brands fa-linkedin', label: 'LinkedIn' },
  { href: 'mailto:kristyreports@gmail.com', icon: 'fa-solid fa-envelope', label: 'Email' },
];
